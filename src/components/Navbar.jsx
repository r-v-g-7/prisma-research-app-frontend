                    ...
                    <div className="flex items-center gap-8">
                        ...
                        {user && (
                            <div className="flex items-center gap-6">
                                <Link
                                    to="/feed"
                                    className={`text-sm font-medium ${isActive('/feed')
                                ...
                                <Link
                                    to="/workspaces"
                                    className={`text-sm font-medium ${isActive('/workspaces')
                                        ? 'text-blue-600 font-semibold'
                                        : 'text-gray-600 hover:text-gray-900'
                                        }`}
                                >
                                ...
                                <Link
                                    to="/create-post"
                                    className={`text-sm font-medium ${isActive('/create-post')
                                        ? 'text-blue-600 font-semibold'
                                        : 'text-gray-600 hover:text-gray-900'
                                        }`}
                                >
                    ...
                    {user && (
                        <div className="flex items-center gap-3">
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="text-sm font-medium border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400"
                            >
                                Logout
                            </Button>
                        </div>
